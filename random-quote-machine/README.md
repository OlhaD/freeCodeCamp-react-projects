The Random Quote Machine is a demo application written in JavaScript using React.js. The app allows to retrieve a random quote and share it to some sotial networks.
